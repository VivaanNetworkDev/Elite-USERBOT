...
from Elite import START_TIME
from Elite import SUDO_USER
from Elite.helper.PyroHelpers import ReplyCheck
from Elite.modules.help import add_command_help
from Elite.modules.bot.inline import get_readable_time

alive_logo = ALIVE_PIC or "https://files.catbox.moe/r35v1e.jpg"
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **ѕυρρσят**: [Click](t.me/VivaanSupport)\n"
        f"├• **¢нαииєℓ**: [Click](t.me/VivaanNetwork)\n"
        f"└• **яєρσ**: [Click](https://github.com/VivaanNetworkDev/ELITE-USERBOT)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Here is repo: \n\n\nhttps://github.com/VivaanNetworkDev/ELITE-USERBOT\nFork & Give an ⭐")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("https://gitHub.com/VivaanNetworkDev")
