...
from Elite import CMD_HELP, StartTime, app
from Elite.helper.data import Data
from Elite.helper.inline import inline_wrapper, paginate_help
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://files.catbox.moe/r35v1e.jpg",
